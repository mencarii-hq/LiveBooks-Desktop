...
/**
 * Resolve the LiveBooks Online origin for main-process HTTP calls.
 *
...
/**
 * derive the Online user id (+sub+) from the access JWT.
 *
...
> {
  ...
  return { ok: false, message: 'Unexpected response from LiveBooks Online.' };
}
