...
const languageMap: LanguageMap = {
  ...
  '${0} cannot be cancelled': {
    translation: '${0} cannot be cancelled',
  },
  '${0} cannot be deleted': {
    translation: '${0} 无法删除',
  },
  ...
  '${0} entry imported': {
    translation: '已导入 ${0} 条目',
  },
  '${0} fields selected': {
    translation: '已选择 ${0} 个字段',
  },
  '${0} filters applied': {
  ...
  '${0} party ${1} is different from ${2}': {
    translation: '${0} 参与方 ${1} 与 ${2} 不同',
  },
  '${0} quantity 1 added.': {
    translation: '添加了 ${0} 数量1',
  },
  '${0} row added.': {
    translation: '已添加 ${0} 行',
  },
  ...
  'A submittable entry is deleted only if it is in the cancelled state.': {
    translation: '只有当可提交条目处于取消状态时，才会删除该条目',
  },
  Account: {
    translation: '科目',
  },
  'Account ${0} does not exist.': {
    translation: '账户 ${0} 不存在',
  },
  'Account Entries': {
    translation: '帐户条目',
  },
  ...
  'Add a few customers to create your first sales invoice': {
    translation: '添加几个客户创建您的第一张销售订单',
  },
  'Add a few suppliers to create your first purchase invoice': {
    translation: '添加一些供应商以创建您的第一张采购订单',
  },
  'Add a filter': {
    translation: '添加过滤器',
  },
  ...
  'Batch not set for row ${0}.': {
    translation: '未为第 ${0} 行设置批次',
  },
  'Batch set for row ${0}.': {
    translation: '第 ${0} 行的批处理集',
  },
  'Bill Created': {
    translation: '账单已创建',
  },
  ...
  'Both From and To Location cannot be undefined': {
    translation: '“起始位置”和“终止位置”都不能未定义',
  },
  Buildings: {
    translation: '建筑物',
  },
  ...
  'Cannot cancel ${0} ${1} because of the following ${2}: ${3}': {
    translation: '由于以下 ${2} ，无法取消 ${0} ${1} : ${3}',
  },
  'Cannot delete ${0} "${1}" because of linked entries.': {
    translation: '由于存在链接条目，无法删除 ${0} "${1}" ',
  },
  'Cannot open file': {
    translation: '无法打开文件',
  },
  ...
  'Changes made to settings will be visible on reload.': {
    translation: '对设置所做的更改将在重新加载时可见',
  },
  Chargeable: {
    translation: '收费',
  },
  'Chart Of Accounts Reviewed': {
    translation: '已审核的会计科目表',
  },
  'Chart of Accounts': {
    translation: '会计科目表',
  },
  ...
  'Could not connect to database file ${0}, please select the file manually': {
    translation: '无法连接到数据库文件 ${0}，请手动选择该文件',
  },
  Country: {
    translation: '国家',
  },
  ...
  'Customize your invoices by adding a logo and address details': {
    translation: '通过添加徽标和地址详细信息自定义您的发票',
  },
  Dashboard: {
    translation: '仪表板',
  },
  ...
  'Directory for database file ${0} does not exist, please select the file manually':
    {
      translation: '数据库文件 ${0} 的目录不存在，请手动选择该文件',
    },
  Disabled: {
    translation: '有残疾的',
  },
  ...
  'Discount Amount (${0}) cannot be greated than Amount (${1}).': {
    translation: '折扣金额 (${0}) 不能大于金额 (${1})',
  },
  'Discount Percent': {
    translation: '折扣百分比',
  },
  'Discount Percent (${0}) cannot be greater than 100.': {
    translation: '折扣百分比 (${0}) 不能大于100',
  },
  'Discounted Amount': {
    translation: '贴现金额',
  },
  ...
  'Fieldname ${0} already exists for ${1}': {
    translation: ' ${1} 的字段名 ${0} 已存在',
  },
  'Fieldname ${0} already used for Custom Field ${1}': {
    translation: '字段名 ${0} 已用于自定义字段 ${1}',
  },
  Fieldtype: {
    translation: '字段类型',
  },
  'File ${0} does not exist.': {
    translation: '文件 ${0} 不存在',
  },
  ...
  'Fiscal Year End Date': {
    translation: '财政年度结束日期',
  },
  'Fiscal Year Start Date': {
    translation: '财政年度开始日期',
  },
  'Fix Failed': {
    translation: '修复失败',
  },
  ...
  'Following cells have errors: ${0}.': {
    translation: '以下单元格有错误: ${0}',
  },
  'Following links do not exist: ${absentLinks .map((l) =>': {
    translation: '以下链接不存在: ${absentLinks .map((l) =>',
  },
  Font: {
    translation: '字体',
  },
  ...
  'Invalid barcode value ${0}.': {
    translation: '无效条形码值 ${0}',
  },
  'Invalid value ${0} for ${1}': {
    translation: '${1} 的值 ${0} 无效',
  },
  'Invalid value found for ${0}': {
    translation: '为 ${0} 找到无效值',
  },
  Inventory: {
    translation: '库存',
  },
  ...
  'Item with From location not found': {
    translation: '未找到带有发件人仓库的商品',
  },
  'Item with To location not found': {
    translation: '未找到含有收件人仓库的商品',
  },
  'Item with barcode ${0} not found.': {
    translation: '未找到带有条形码 ${0} 的商品',
  },
  Items: {
    translation: '商品',
  },
  ...
  'No entries were imported.': {
    translation: '没有输入任何条目',
  },
  'No expenses in this period': {
    translation: '这期间没有任何费用',
  },
  'No filters selected': {
    translation: '没有选择过滤器',
  },
  ...
  'Open Print View if Print is available.': {
    translation: '如果可以打印，则打开打印视图',
  },
  'Open Quick Search': {
    translation: '打开快速搜索',
  },
  'Open Report Print View': {
    translation: '打开报告打印视图',
  },
  'Open the Export Wizard modal': {
    translation: '打开导出向导模式',
  },
  'Opening (Cr)': {
    translation: '正在打开 (贷方)',
  },
  ...
  'Qty. in Transfer Unit': {
    translation: '传送装置中的数量',
  },
  Quantity: {
    translation: '数量',
  },
  'Quantity (${0}) has to be greater than zero': {
    translation: '数量 (${0}) 必须大于零',
  },
  ...
  'Quick edit error: ${0} entry has no name.': {
    translation: '快速编辑错误：${0} 条目没有名称',
  },
  Rate: {
    translation: '价格',
  },
  'Rate (${0}) cannot be less zero.': {
    translation: '价格 (${0}) 不能小于零。',
  },
  'Rate (${0}) has to be greater than zero': {
    translation: '价格 (${0}) 必须大于零',
  },
  ...
  'Report will use more than one page if required.': {
    translation: '如果需要，报告将使用多于一页的篇幅',
  },
  Reports: {
    translation: '报告',
  },
  'Required fields not selected: ${0}': {
    translation: '未选择必填字段： ${0}',
  },
  'Retained Earnings': {
    translation: '保留收益',
  },
  ...
  'Review your chart of accounts, add any account or tax heads as needed': {
    translation: '查看您的科目表，根据需要添加任何科目或税目',
  },
  'Right Index': {
    translation: '右索引',
  },
  ...
  'Save as PDF Successful': {
    translation: '另存为 PDF 成功',
  },
  'Save changes made to ${0}?': {
    translation: '保存对 ${0} 所做的更改？',
  },
  'Save or Submit an entry.': {
    translation: '保存或提交参赛作品',
  },
  Saved: {
    translation: '已保存',
  },
  ...
  'Serial Number ${0} does not belong to the item ${1}.': {
    translation: '序列号 ${0} 不属于商品 ${1}',
  },
  'Serial Number ${0} does not exist.': {
    translation: '序列号 ${0} 不存在',
  },
  'Serial Number ${0} is not Active.': {
    translation: '序列号 ${0} 未激活',
  },
  ...
  'Setup system defaults like date format and display precision': {
    translation: '设置系统默认值，如日期格式和显示精度',
  },
  Shipment: {
    translation: '发货单',
  },
  ...
  'Something has gone terribly wrong. Please check the console and raise an issue.':
    {
      translation: '发生了严重的错误。 请检查控制台并提出问题。',
    },
  ...
  'Stock Received But Not Billed': {
    translation: '库存已收到但未开票',
  },
  'Stock Received But Not Billed Acc.': {
    translation: '已收到但未开具账单的库存',
  },
  'Stock Transfer Item': {
    translation: '库存转让商品',
  },
  ...
  'This action is permanent and will delete associated ledger entries.': {
    translation: '此操作是永久性的，并将删除相关的分类帐条目。',
  },
  'This action is permanent.': {
    translation: '此操作是永久性的。',
  },
  ...
  'Toggle Linked Entries widget, not available in Quick Edit view.': {
    translation: '切换链接条目部件，在快速编辑视图中不可用',
  },
  'Toggle between form and full width': {
    translation: '在表格和全宽之间切换',
  },
  'Toggle sidebar': {
    translation: '切换侧边栏',
  },
