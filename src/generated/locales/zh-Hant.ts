...
const languageMap: LanguageMap = {
  ...
  '${0} party ${1} is different from ${2}': {
    translation: '${0} 參與方 ${1} 與 ${2} 不同',
  },
  '${0} quantity 1 added.': {
    translation: '已新增 ${0} 數量 1',
  },
  '${0} row added.': {
    translation: '已新增 ${0} 行',
  },
  ...
  'A submittable entry is deleted only if it is in the cancelled state.': {
    translation: '只有在可提交條目處於取消狀態時，才會刪除該條目',
  },
  Account: {
    translation: '科目',
  },
  'Account ${0} does not exist.': {
    translation: '帳戶（科目） ${0} 不存在',
  },
  'Account Entries': {
    translation: '帳戶條目',
  },
  ...
  'Add a few customers to create your first sales invoice': {
    translation: '新增幾位客戶以建立您的第一張銷售發票',
  },
  'Add a few suppliers to create your first purchase invoice': {
    translation: '新增幾位供應商以建立您的第一張採購入帳單',
  },
  'Add a filter': {
    translation: '新增篩選條件',
  },
  ...
  'Batch not set for row ${0}.': {
    translation: '尚未為第 ${0} 行設定批次',
  },
  'Batch set for row ${0}.': {
    translation: '已為第 ${0} 行設定批次',
  },
  'Bill Created': {
    translation: '帳單已建立',
  },
  ...
  'Both From and To Location cannot be undefined': {
    translation: '「起始位置」和「終止位置」都不能未定義',
  },
  Buildings: {
    translation: '建築物',
  },
  ...
  'Changes made to settings will be visible on reload.': {
    translation: '對設定所做的更改將在重新載入時生效',
  },
  Chargeable: {
    translation: '需收費',
  },
  'Chart Of Accounts Reviewed': {
    translation: '已審核的會計科目表',
  },
  'Chart of Accounts': {
    translation: '會計科目表',
  },
  ...
  'Could not connect to database file ${0}, please select the file manually': {
    translation: '無法連線到資料庫檔案 ${0}，請手動選擇該檔案',
  },
  Country: {
    translation: '國家',
  },
  'Country Code': {
    translation: '國家（地區）代碼',
  },
  'Country code used to initialize regional settings.': {
    translation: '用於初始化區域設定的國家/地區代碼。',
  },
  Courier: {
    translation: '快遞',
  },
  ...
  'Directory for database file ${0} does not exist, please select the file manually':
    {
      translation: '資料庫檔案 ${0} 的目錄不存在，請手動選擇檔案',
    },
  Disabled: {
    translation: '停用',
  },
  ...
  'Discount Amount (${0}) cannot be greated than Amount (${1}).': {
    translation: '折扣金額 (${0}) 不可大於金額 (${1})',
  },
  'Discount Percent': {
    translation: '折扣百分比',
  },
  'Discount Percent (${0}) cannot be greater than 100.': {
    translation: '折扣百分比 (${0}) 不可大於 100',
  },
  'Discounted Amount': {
    translation: '折抵後金額',
  },
  ...
  'Fieldname ${0} already exists for ${1}': {
    translation: '${1} 的欄位名稱 ${0} 已存在',
  },
  'Fieldname ${0} already used for Custom Field ${1}': {
    translation: '欄位名稱 ${0} 已用於自訂欄位 ${1}',
  },
  Fieldtype: {
    translation: '欄位類型',
  },
  'File ${0} does not exist.': {
    translation: '檔案 ${0} 不存在',
  },
  ...
  'Fiscal Year End Date': {
    translation: '財政年度結束日期',
  },
  'Fiscal Year Start Date': {
    translation: '財政年度開始日期',
  },
  'Fix Failed': {
    translation: '修復失敗',
  },
  ...
  'Following cells have errors: ${0}.': {
    translation: '以下儲存格出現錯誤：${0}',
  },
  'Following links do not exist: ${absentLinks .map((l) =>': {
    translation: '以下連結不存在：${absentLinks .map((l) =>',
  },
  Font: {
    translation: '字型',
  },
  ...
  'Hides the Get Started section from the sidebar. Change will be visible on restart or refreshing the app.':
    {
      translation:
        '從側邊欄隱藏「開始使用」區域。重新啟動或重新整理應用後會生效。',
    },
  Hour: {
    translation: '小時',
  },
  ...
  'Invalid barcode value ${0}.': {
    translation: '無效的條碼值 ${0}',
  },
  'Invalid value ${0} for ${1}': {
    translation: '${1} 的值 ${0} 無效',
  },
  ...
  'Item ${0} is a batched item': {
    translation: '商品 ${0} 為批次商品',
  },
  'Item ${0} is not a batched item': {
    translation: '商品 ${0} 不是批次商品',
  },
  'Item Description': {
    translation: '商品描述',
  },
  ...
  'Item with From location not found': {
    translation: '找不到含「來源倉庫」的商品',
  },
  'Item with To location not found': {
    translation: '找不到含「目標倉庫」的商品',
  },
  'Item with barcode ${0} not found.': {
    translation: '找不到條碼為 ${0} 的商品',
  },
  Items: {
    translation: '商品',
  },
  ...
  'No Display Entries Found': {
    translation: '找不到可顯示的條目',
  },
  'No Print Templates not found for entry type ${0}': {
    translation: '未找到適用於條目類型 ${0} 的列印範本',
  },
  'No Value': {
    translation: '無值',
  },
  ...
  'Only From or To can be set for Manufacture': {
    translation: '只能為「製造」設定「從」或「到」其一。',
  },
  'Open Count': {
    translation: '開啟計數',
  },
  ...
  'Open Print View if Print is available.': {
    translation: '若可列印，則開啟列印預覽',
  },
  'Open Quick Search': {
    translation: '開啟快速搜尋',
  },
  'Open Report Print View': {
    translation: '開啟報表列印視圖',
  },
  'Open the Export Wizard modal': {
    translation: '開啟匯出精靈對話',
  },
  'Opening (Cr)': {
    translation: '正在開啟（貸方）',
  },
  ...
  'Purchase Invoice Number Series': {
    translation: '採購訂單號碼系列',
  },
  'Purchase Invoice Print Template': {
    translation: '採購訂單列印範本',
  },
  ...
  'Quick edit error: ${0} entry has no name.': {
    translation: '快速編輯錯誤：${0} 條目沒有名稱',
  },
  Rate: {
    translation: '價格',
  },
  'Rate (${0}) cannot be less zero.': {
    translation: '價格 (${0}) 不可小於零。',
  },
  'Rate (${0}) has to be greater than zero': {
    translation: '價格 (${0}) 必須大於零',
  },
  ...
  'Report will use more than one page if required.': {
    translation: '若需要，報表會使用多頁',
  },
  Reports: {
    translation: '報表',
  },
  'Required fields not selected: ${0}': {
    translation: '未選擇必填欄位：${0}',
  },
  'Retained Earnings': {
    translation: '保留盈餘',
  },
  ...
  'Review your chart of accounts, add any account or tax heads as needed': {
    translation: '檢視您的會計科目表，依需求新增科目或稅目',
  },
  'Right Index': {
    translation: '右索引',
  },
  ...
  'Sales Invoice Number Series': {
    translation: '銷售訂單號碼系列',
  },
  'Sales Invoice Print Template': {
    translation: '銷售訂單列印範本',
  },
  'Sales Invoice Terms': {
    translation: '銷售訂單條款',
  },
  ...
  'Save as PDF Successful': {
    translation: '另存為 PDF 成功',
  },
  'Save changes made to ${0}?': {
    translation: '是否儲存對 ${0} 所做的變更？',
  },
  ...
  'Setup system defaults like date format and display precision': {
    translation: '設定系統預設值，例如日期格式與顯示精度',
  },
  Shipment: {
    translation: '出貨單',
  },
  ...
  'Something has gone terribly wrong. Please check the console and raise an issue.':
    {
      translation: '發生了嚴重錯誤。請檢查主控台並提交問題。',
    },
  ...
  'Stock Movement Number Series': {
    translation: '庫存移動號碼系列',
  },
  'Stock Movement Print Template': {
    translation: '庫存移動列印範本',
  },
  'Stock Movements': {
    translation: '庫存移動',
  },
  ...
  'Stock Received But Not Billed': {
    translation: '庫存已接收但未開立帳單',
  },
  'Stock Received But Not Billed Acc.': {
    translation: '庫存已接收但尚未開帳的帳戶',
  },
  'Stock Transfer Item': {
    translation: '庫存轉移商品',
  },
  ...
  'This action is permanent and will delete associated ledger entries.': {
    translation: '此操作為永久性的，並將刪除相關分類帳分錄。',
  },
  'This action is permanent.': {
    translation: '此操作為永久性的。',
  },
  ...
  'Toggle Linked Entries widget, not available in Quick Edit view.': {
    translation: '切換連結條目小工具，快速編輯視圖中無法使用',
  },
  'Toggle between form and full width': {
    translation: '在表單與全寬模式間切換',
  },
  'Toggle sidebar': {
    translation: '切換側邊欄',
  },
  'Toggle the Create filter': {
    translation: '切換「建立」篩選器',
  },
  'Toggle the Docs filter': {
    translation: '切換「文件」篩選器',
  },
  'Toggle the List filter': {
    translation: '切換「列表」篩選器',
  },
  'Toggle the Page filter': {
    translation: '切換「頁面」篩選器',
  },
  'Toggle the Report filter': {
    translation: '切換「報表」篩選器',
  },
  'Top Expenses': {
    translation: '費用明細',
  },
